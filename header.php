...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2 sticky-top"  style="background-color:darkgreen">
    ...
    <a class="navbar-brand" href="index.html" style="color:white;"><span class="fa fa-trophy" style="color:#D4AF37;"></span> Champion News</a>
    ...
    <a class="navbar-brand" href="#index.html">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item">
		  <div class='dropdown'>
            <a class="nav-link dropdown-toggle" style="color:white;" data-toggle="dropdown" href="index.php?page=infra_index">Articles</a>
